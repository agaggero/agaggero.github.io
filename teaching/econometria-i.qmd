...
**Appendices** — mathematical and statistical prerequisites · Wooldridge ↔ Carter–Griffiths–Lim crosswalk · statistical tables.

## Open textbook

I'm writing an open companion textbook — ***Econometrics I: Theory, Practice, and Applications*** — under a **CC BY 4.0** license. It consolidates three years of teaching materials (lecture notes, R tutorials, and interactive self-assessments) into a single reproducible volume, built with Quarto.

📖 *Online edition coming soon. A Spanish edition is in preparation.*
